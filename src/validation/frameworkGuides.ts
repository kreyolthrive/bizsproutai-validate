...
const FRAMEWORK_GUIDES: FrameworkGuide[] = [
  ...
  },
  {
    ...
    analysisInstructions: [
      "CRITICAL: This is a SOFTWARE PRODUCT being built. The business model is SaaS, NOT the end user's business.",
      "Separate what is being built (software product) from who it serves. The customer segment defines the vertical niche, not the business category.",
      "Determine the tool type: Is this a CRM/workflow tool (contacts, pipeline, projects) or a booking/scheduling tool (appointments, time slots)?",
      "For CRM/workflow tools: Evaluate against Notion, Airtable, Trello, HoneyBook, Dubsado, and other horizontal tools. Why would the target segment switch?",
      "For booking/scheduling tools: Evaluate against Square, Acuity, Calendly, and existing booking solutions. What is the switching friction?",
      "Evaluate whether the target users will actually pay monthly for this software instead of using free alternatives or existing tools.",
      "Assess willingness to pay: Do these users already pay for software? What is their budget for tools?",
      "Evaluate switching friction: Are users locked into existing solutions? How heavy is migration?",
      "Assess acquisition difficulty: How will you reach these users? Are they reachable via communities, content, Twitter/X, or cold outreach?",
      "Evaluate workflow depth: Does the product solve enough daily pain to become sticky, or is it a nice-to-have?",
      "Assess competitive landscape: What existing tools target this niche? How is this different?",
      "Do not apply local-service or coaching logic. This is about selling software TO a segment, not being that segment.",
    ],
  },
  {
    id: "saas_v1",
