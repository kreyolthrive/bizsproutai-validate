  ...
  return JSON.stringify(
    {
      ...
      instructions: [
        ...
        "If the frameworkGuide is vertical_saas_v1, focus on: operator willingness to pay, switching friction from existing tools, acquisition difficulty to reach the niche, and retention/churn risk.",
        "For vertical SaaS targeting local service operators, evaluate: Do barbers/salons/etc actually pay for scheduling software? What are they using now? How hard is it to reach them?",
