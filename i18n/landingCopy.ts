...
export function getLandingCopy(locale: string) {
  ...
  const base = {
    ...
    /* ── Mini cards ───────────────────────────────── */
    miniCards: [
      { icon: "⚡", title: "48h", subtitle: "Time to launch" },
    ...
    howSteps: [
      {
        number: "01",
        title: "Week One — Clarity",
        body: "Lock in the right idea, define who will pay for it, and shape an offer built around real demand — not guesswork.",
        tag: "Idea validation + offer creation",
      },
      {
        number: "02",
        title: "Week Two — Launch",
        body: "Build your website, sharpen your messaging, and set up the booking and follow-up system that supports your business.",
        tag: "Website + systems live in 48h",
      },
      {
        number: "03",
        title: "Week Three — Outreach",
        body: "Start attracting leads, begin real conversations, and put your offer in front of the right people with messaging designed to get replies.",
        tag: "First client acquisition scripts included",
      },
      {
        number: "04",
        title: "Week Four — Conversion",
        body: "Refine your pitch, tighten your process, and work toward your first paying customer with more confidence and a repeatable system.",
        tag: "Repeatable system you own",
      },
    ],
  ...
  if (lang === "fr") {
    return {
      ...
      miniCards: [
        { icon: "⚡", title: "48h", subtitle: "Délai de lancement" },
      ...
      howSteps: [
        { number: "01", title: "Semaine un — Clarté", body: "Validez la bonne idée, définissez qui va payer pour elle, et façonnez une offre construite autour de la vraie demande — pas des suppositions.", tag: "Validation d'idée + création d'offre" },
        { number: "02", title: "Semaine deux — Lancement", body: "Construisez votre site web, affinez votre message, et mettez en place le système de réservation et de suivi qui soutient votre business.", tag: "Site web + systèmes en ligne en 48h" },
        { number: "03", title: "Semaine trois — Prospection", body: "Commencez à attirer des prospects, engagez de vraies conversations, et présentez votre offre aux bonnes personnes avec un message conçu pour obtenir des réponses.", tag: "Scripts d'acquisition premier client inclus" },
        { number: "04", title: "Semaine quatre — Conversion", body: "Affinez votre pitch, resserrez votre processus, et travaillez vers votre premier client payant avec plus de confiance et un système reproductible.", tag: "Un système reproductible qui vous appartient" },
      ],
  ...
  if (lang === "es") {
    return {
      ...
      miniCards: [
        { icon: "⚡", title: "48h", subtitle: "Tiempo de lanzamiento" },
      ...
      howSteps: [
        { number: "01", title: "Semana uno — Claridad", body: "Define la idea correcta, identifica quién va a pagar por ella, y crea una oferta construida alrededor de demanda real — no suposiciones.", tag: "Validación de idea + creación de oferta" },
        { number: "02", title: "Semana dos — Lanzamiento", body: "Construye tu sitio web, afina tu mensaje, y configura el sistema de reservas y seguimiento que respalda tu negocio.", tag: "Sitio web + sistemas en línea en 48h" },
        { number: "03", title: "Semana tres — Prospección", body: "Empieza a atraer prospectos, inicia conversaciones reales, y pon tu oferta frente a las personas correctas con mensajes diseñados para obtener respuestas.", tag: "Scripts de adquisición de primer cliente incluidos" },
        { number: "04", title: "Semana cuatro — Conversión", body: "Refina tu pitch, ajusta tu proceso, y trabaja hacia tu primer cliente de pago con más confianza y un sistema repetible.", tag: "Un sistema repetible que es tuyo" },
      ],
  ...
  if (lang === "ht") {
    return {
      ...
      miniCards: [
        { icon: "⚡", title: "48h", subtitle: "Tan pou lanse" },
      ...
      howSteps: [
        { number: "01", title: "Semèn youn — Klète", body: "Fikse bon lide a, defini kiyès ki pral peye pou li, epi kreye yon òf ki bati sou vrè demand — pa sipozisyon.", tag: "Validasyon lide + kreyasyon òf" },
        { number: "02", title: "Semèn de — Lansman", body: "Bati sit wèb ou, file mesaj ou, epi mete kanpe sistèm rezèvasyon ak swivi ki sipòte biznis ou.", tag: "Sit wèb + sistèm an liy nan 48è" },
        { number: "03", title: "Semèn twa — Pwospeksyon", body: "Kòmanse atire prospèk, kòmanse vrè konvèsasyon, epi mete òf ou devan bon moun yo ak mesaj ki fèt pou jwenn repons.", tag: "Script akizisyon premye kliyan enkli" },
        { number: "04", title: "Semèn kat — Konvèsyon", body: "Rafine pitch ou, sere pwosesis ou, epi travay pou jwenn premye kliyan peyan ou ak plis konfyans ak yon sistèm ou ka repete.", tag: "Yon sistèm repetab ki pou ou" },
      ],
  ...
  if (lang === "pt") {
    return {
      ...
      miniCards: [
        { icon: "⚡", title: "48h", subtitle: "Tempo para lançar" },
      ...
      howSteps: [
        { number: "01", title: "Semana um — Clareza", body: "Defina a ideia certa, identifique quem vai pagar por ela, e crie uma oferta construída em torno de demanda real — não suposições.", tag: "Validação de ideia + criação de oferta" },
        { number: "02", title: "Semana dois — Lançamento", body: "Construa seu site, refine sua mensagem, e configure o sistema de agendamento e acompanhamento que sustenta seu negócio.", tag: "Site + sistemas no ar em 48h" },
        { number: "03", title: "Semana três — Prospecção", body: "Comece a atrair leads, inicie conversas reais, e coloque sua oferta na frente das pessoas certas com mensagens feitas para gerar respostas.", tag: "Scripts de aquisição do primeiro cliente incluídos" },
        { number: "04", title: "Semana quatro — Conversão", body: "Refine seu pitch, ajuste seu processo, e trabalhe rumo ao seu primeiro cliente pagante com mais confiança e um sistema repetível.", tag: "Um sistema repetível que é seu" },
      ],
